...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_60_tsangan_hhkb(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MS_UP, _______, _______,
        _______, MS_BTN3, MS_BTN2, MS_BTN1, _______, _______, _______, _______, MS_WHLL, MS_WHLU, MS_LEFT, MS_RGHT, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, MS_WHLR, MS_WHLD, MS_DOWN, _______, _______,
